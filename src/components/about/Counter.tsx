...
export default function Counter ({start, end, duration, last, title}: 
    {start: number, end: number, duration: number, last?: boolean, title: string})
{
    ...
    return(
        <div className={`${!last && divisorStyles} relative flex-1`}>
            <h3 className="text-2xl xl:text-4xl font-extrabold text-indigo-500 
