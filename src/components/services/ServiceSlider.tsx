...
export default function ServiceSlider({servicesData}:
        ...
        >
            {servicesData.map((service: ServicesData, index: number) => {
                ...
                <SwiperSlide key={index} className='overflow-y-auto'>
                    <section className='bg-[rgba(55,47,123,0.15)] hover:bg-[rgba(89,65,169,0.15)]
                    ...
                    sm:gap-x-0 group cursor-pointer text-black dark:text-white/40'>
                        ...
                        <div 
                        className='text-4xl text-indigo-500 dark:text-accent font-bold'>
                            {service.icon}
                        </div>
                        
                        <div>
                            <h3 className='text-black dark:text-white font-bold my-2'>{service.title}</h3>
                            <p 
                            className='max-w-[350px] leading-normal text-black dark:text-white/40'>
                                {service.description}
                            </p>
                        </div>
