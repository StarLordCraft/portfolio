    ...
    return (
        <>
            <nav className="flex md:hidden items-center justify-between pt-10 px-10 h-full z-40 relative bg-white">
                ...
                <button
                onClick={_setIsOpen}
                className="flex items-center group justify-center p-2 w-10 h-10 text-sm group rounded-lg hover:bg-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-400 gap-1 cursor-pointer">
